(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prop-types'), require('@nivo/core'), require('@nivo/axes'), require('@nivo/legends'), require('@nivo/scales'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/pure'), require('recompose/setDisplayName'), require('@nivo/voronoi'), require('react'), require('react-motion')) :
    typeof define === 'function' && define.amd ? define(['exports', 'prop-types', '@nivo/core', '@nivo/axes', '@nivo/legends', '@nivo/scales', 'recompose/compose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/pure', 'recompose/setDisplayName', '@nivo/voronoi', 'react', 'react-motion'], factory) :
    (factory((global.nivo = global.nivo || {}),global.PropTypes,global.nivo,global.nivo,global.nivo,global.nivo,global.RecomposeCompose,global.RecomposeDefaultProps,global.RecomposeWithPropsOnChange,global.RecomposePure,global.RecomposeSetDisplayName,global.nivo,global.React,global.ReactMotion));
}(this, (function (exports,PropTypes,core,axes,legends,scales,compose,defaultProps,withPropsOnChange,pure,setDisplayName,voronoi,React,reactMotion) { 'use strict';

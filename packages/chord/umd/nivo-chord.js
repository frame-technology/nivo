(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prop-types'), require('@nivo/core'), require('@nivo/legends'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withState'), require('recompose/withPropsOnChange'), require('recompose/pure'), require('d3-shape'), require('d3-chord'), require('react'), require('lodash/isFunction'), require('lodash/mapValues'), require('react-motion'), require('d3-format'), require('recompose/setDisplayName'), require('lodash/partial')) :
    typeof define === 'function' && define.amd ? define(['exports', 'prop-types', '@nivo/core', '@nivo/legends', 'recompose/compose', 'recompose/defaultProps', 'recompose/withState', 'recompose/withPropsOnChange', 'recompose/pure', 'd3-shape', 'd3-chord', 'react', 'lodash/isFunction', 'lodash/mapValues', 'react-motion', 'd3-format', 'recompose/setDisplayName', 'lodash/partial'], factory) :
    (factory((global.nivo = global.nivo || {}),global.PropTypes,global.nivo,global.nivo,global.RecomposeCompose,global.RecomposeDefaultProps,global.RecomposeWithState,global.RecomposeWithPropsOnChange,global.RecomposePure,global.d3,global.d3,global.React,global['lodash/isFunction'],global['lodash/mapValues'],global.ReactMotion,global.d3,global.RecomposeSetDisplayName,global['lodash/partial']));
}(this, (function (exports,PropTypes,core,legends,compose,defaultProps,withState,withPropsOnChange,pure,d3Shape,d3Chord,React,isFunction,mapValues,reactMotion,d3Format,setDisplayName,partial) { 'use strict';
        ...
        return React__default.createElement(
            ...
            function (_ref2) {
                ...
                return React__default.createElement(
                    ...
                    radius > 0 && React__default.createElement(
                        'g',
                        { transform: 'translate(' + centerX + ', ' + centerY + ')' },
                        radius > 0 && React__default.createElement(ChordRibbons$1, _extends({
                            ribbons: ribbons,

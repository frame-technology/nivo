(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prop-types'), require('@nivo/core'), require('recompose/withPropsOnChange'), require('d3-shape'), require('d3-scale'), require('react'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/pure'), require('recompose/setDisplayName'), require('@nivo/axes')) :
  typeof define === 'function' && define.amd ? define(['exports', 'prop-types', '@nivo/core', 'recompose/withPropsOnChange', 'd3-shape', 'd3-scale', 'react', 'recompose/compose', 'recompose/defaultProps', 'recompose/pure', 'recompose/setDisplayName', '@nivo/axes'], factory) :
  (factory((global.nivo = global.nivo || {}),global.PropTypes,global.nivo,global.RecomposeWithPropsOnChange,global.d3,global.d3,global.React,global.RecomposeCompose,global.RecomposeDefaultProps,global.RecomposePure,global.RecomposeSetDisplayName,global.nivo));
}(this, (function (exports,PropTypes,core,withPropsOnChange,d3Shape,d3Scale,React,compose,defaultProps,pure,setDisplayName,axes) { 'use strict';

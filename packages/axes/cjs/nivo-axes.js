...
var AxisTick = function (_PureComponent) {
    ...
    function AxisTick(props) {
        ...
        _this._tickText = React__default.createRef();
        _this.clearHoverTracking = _this.clearHoverTracking.bind(_this);
        _this.moveHoverPanel = _this.moveHoverPanel.bind(_this);
        _this.showHoverPanel = _this.showHoverPanel.bind(_this);
        return _this;
    }

    AxisTick.prototype.componentDidMount = function componentDidMount() {
        if (this.props.axisTooltip && this._tickText.current) {
            this.setUpListeners();
        }
    };

    AxisTick.prototype.componentWillUnmount = function componentWillUnmount() {
        if (this.props.axisTooltip && this._tickText.current) {
            this._tickText.current.removeEventListener("mouseover", this.showHoverPanel);
            this._tickText.current.removeEventListener("mouseout", this.clearHoverTracking);
        }
    };

    AxisTick.prototype.setUpListeners = function setUpListeners() {
        this._tickText.current.addEventListener("mouseover", this.showHoverPanel);
        this._tickText.current.addEventListener("mouseout", this.clearHoverTracking);
    };

    AxisTick.prototype.showHoverPanel = function showHoverPanel(e) {
        this._tickText.current.addEventListener("mousemove", this.moveHoverPanel);
        this.moveHoverPanel(e);
    };

    AxisTick.prototype.clearHoverTracking = function clearHoverTracking() {
        this.props.hideHover && this.props.hideHover();
        this._tickText.current.removeEventListener("mousemove", this.moveHoverPanel);
    };

    AxisTick.prototype.moveHoverPanel = function moveHoverPanel(e) {
        this.props.moveHoverPanel && this.props.moveHoverPanel(e);
    };
...
var Axis = function (_Component) {
    ...
    Axis.prototype.render = function render() {
        var _props = this.props,
            ...
            axisTooltip = _props.axisTooltip,
            moveHoverPanel = _props.moveHoverPanel,
            hideHover = _props.hideHover;
...
var Axes = function (_PureComponent) {
    ...
    function Axes(props) {
        ...
        if (props.axisTooltip) {
            _this.moveHoverPanel = _this.moveHoverPanel.bind(_this);
            _this.hideHover = _this.hideHover.bind(_this);
        }
        return _this;
    }

    Axes.prototype.handleNodeHover = function handleNodeHover(showTooltip, event) {
        var _props = this.props,
            theme = _props.theme,
    ...
    Axes.prototype.moveHoverPanel = function moveHoverPanel(e) {
        this.handleNodeHover(this.props.showTooltip, e);
    };

    Axes.prototype.hideHover = function hideHover() {
    ...
    Axes.prototype.render = function render() {
        var _props2 = this.props,
            ...
            axisTooltip = _props2.axisTooltip;
        var moveHoverPanel = this.moveHoverPanel,

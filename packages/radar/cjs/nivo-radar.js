            ...
            return React__default.createElement(
                ...
                points.map(function (point) {
                    return React__default.createElement(core.DotsItem, {
                        ...
                        y: point.style.y,
                        symbol: symbol,
                        size: size instanceof Function ? size(point) : size,
                ...
                styles: points.map(function (point) {
                    return {
                        ...
                        style: {
                            ...
                            size: size instanceof Function ? reactMotion.spring(size(point), springConfig) : reactMotion.spring(size, springConfig)
                        }
                    };
                })
            },

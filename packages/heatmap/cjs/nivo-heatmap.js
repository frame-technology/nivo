...
var HeatMapCanvas = function (_Component) {
    ...
    HeatMapCanvas.prototype.draw = function draw(props) {
        ...
        if (cellShape === 'rect') {
            renderNode = partial(renderRect, this.ctx, { enableLabels: enableLabels, theme: theme });
        } else {
            renderNode = partial(renderCircle, this.ctx, { enableLabels: enableLabels, theme: theme });
        }
